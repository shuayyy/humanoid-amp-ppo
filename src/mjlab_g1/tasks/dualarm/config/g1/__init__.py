...
This makes the code more modular. To add a new task such as dual-arm manipulation, we only register a new task in the task folder. We do not need to modify the main training script with new `if/else` logic.
